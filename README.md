...
1. Copy the [`leaguepass.py`](c:\Users\simon\AppData\Roaming\streamlink\plugins\leaguepass.py) file to your Streamlink plugins directory:
...
This project is licensed under the [Unlicense](c:\Users\simon\AppData\Roaming\streamlink\plugins\LICENSE) - see the LICENSE file for details.